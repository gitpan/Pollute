# This Makefile is for the Pollute extension to perl.
#
...
#	ABSTRACT_FROM => q[Pollute.pm]
#	AUTHOR => q[A. U. Thor <a.u.thor@a.galaxy.far.far.away>]
#	NAME => q[Pollute]
#	PREREQ_PM => {  }
#	VERSION_FROM => q[Pollute.pm]
...
subdirs ::
	@cd Persistent && $(MAKE) all $(PASTHRU)
...
clean ::
	-cd Persistent && $(TEST_F) Makefile && $(MAKE) clean
...
test :: $(TEST_TYPE)
	@cd Persistent && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
